...
const InvoiceTemplate = forwardRef(({ invoiceData }, ref) => {
    ...
    return (
        <div ref={ref} className="invoice-container bg-white" style={{ width: '210mm', minHeight: '297mm', padding: '15mm', fontFamily: 'Arial, sans-serif', fontSize: '10pt' }}>

            {/* Header */}
            <div style={{ borderBottom: '3px solid #000', paddingBottom: '10px', marginBottom: '15px' }}>
                <h1 style={{ fontSize: '18pt', fontWeight: 'bold', margin: 0 }}>PROFORMA INVOICE</h1>
            </div>
                ...
                <tbody>
                    <tr>
                        <td style={{ border: '1px solid #000', padding: '10px', width: '60%', verticalAlign: 'top' }}>
                            <h3 style={{ color: '#4169E1', margin: '0 0 5px 0', fontSize: '12pt' }}>HERBIFIED HEALTHCARE</h3>
                            <p style={{ fontSize: '9pt', lineHeight: '1.4', margin: '3px 0' }}>
                                DB/2, SECOND FLOOR, OKHLA INDUSTRIAL AREA, PHASE-II,<br />
                                New Delhi, South East Delhi, South Delhi, Delhi, 110044<br />
                                <strong>GSTIN:</strong> 07HSAPK6379D1ZJ &nbsp; <strong>Mobile:</strong> 7982832627<br />
                                <strong>Website:</strong> www.herbified.co.in
                            </p>
                        </td>
                        <td style={{ border: '1px solid #000', padding: '10px', width: '40%' }}>
                            <table style={{ width: '100%', fontSize: '9pt' }}>
                                <tbody>
                                    <tr>
                                        <td><strong>Proforma Invoice No.</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ textAlign: 'right' }}>{formatDate(expiryDate)}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style={{ width: '65%', verticalAlign: 'top', paddingRight: '10px' }}>
                            <div style={{ border: '1px solid #000', padding: '10px' }}>
                                ...
                                <p style={{ fontSize: '9pt', lineHeight: '1.6', margin: 0 }}>
                                    <strong>Name:</strong> {bankDetails.name || 'Herbified Healthcare'}<br />
                                    <strong>IFSC Code:</strong> {bankDetails.ifsc || '19FRB020148'}<br />
                                    <strong>Account No:</strong> {bankDetails.account || '920084119670'}<br />
                                    <strong>Bank:</strong> {bankDetails.bank || 'IDFC FIRST Bank, VIKAS MARG BRANCH'}
                                </p>
                            </div>
                        </td>
                        <td style={{ width: '35%', verticalAlign: 'top' }}>
                            <div style={{ border: '1px solid #000', padding: '10px', textAlign: 'center' }}>
                                ...
                                {paymentQRData && (
                                    <QRCode value={paymentQRData} size={100} />
                                )}
            ...
            <div style={{ textAlign: 'right', paddingTop: '40px' }}>
                ...
                <p style={{ fontSize: '10pt', margin: '5px 0 0 0', fontWeight: 'bold' }}>HERBIFIED HEALTHCARE</p>
            </div>
